...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/abou.css">
...
<li class="nav-item active">
  <a class="nav-link" href="#" id="mathbee" style="color:white">Login<span class="sr-only">(current)</span></a>
</li>
<li class="nav-item active">
...
<li class="nav-item active">
 ...
 <div class="yes">
   <div class="container">
         <h1 style="color: white; text-shadow: 5px 5px black; padding-top: 3rem;">ABOUT US</h1>
         <div class="jumbotron">
      <p class="lead">We are a team of students who aim to present an insight of college to school students through conducting events.
        Through such events we bring in fun, learning and competition together. We encourage them to find a practical application to their
        learnings and aim to boost their self-confidence. Back-2-School is event we conduct as an effort to fulfil our aim. We try to come
        up with more interesting and fun ideas so that the students enjoy to the fullest in events like these.</p>
         </div>
    </div>
 </div>
